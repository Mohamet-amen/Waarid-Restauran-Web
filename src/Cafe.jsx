...
import imge1 from './coffee/c1.jpg'
import imge2 from './coffee/c2.jpg'
import imge3 from './coffee/c3.jpg'
import imge4 from './coffee/c4.jpg'
import imge5 from './coffee/c5.jpg'
import imge7 from './coffee/c7.jpg'
import imge8 from './coffee/c8.jpg'
import imge9 from './coffee/c9.jpg'
const Cafe = () => {
  //Adding to cart page
  ...
  const addToCart = (item) => {
    ...
    alert(' Waxaa Dalbatay!'+item.name  );
    navigate('/Cart');
  };
  const products = [
    { id: 9, name: 'Milk-Coffee', price: 2.99, image: imge2, description: 'This food contains a lot of proteins' },
    { id: 10, name: 'Normal-Coffee', price: 1.99, image: imge3, description: 'This Malawax is best for everyone' },
    { id: 11, name: 'Coffee-Shake', price: 5.99, image: imge4, description: 'This is a fresh meal you can get it' },
    { id: 12, name: 'Shake-Coffee', price: 3.99, image: imge5, description: 'This sandwich contains more proteins' },
    { id: 13, name: 'Take-AwayCoffe', price: 4.99, image: imge1, description: 'This is the best chicken for all' },
    { id: 14, name: 'Cold-Coffee', price: 3.49, image: imge7, description: 'You can get it in our restaurant' },
    { id: 15, name: 'Black-Coffee', price: 2.49, image: imge8, description: 'Sweets is one of our fav foods' },
    { id: 16, name: 'Coffee', price: 4.49, image: imge9, description: 'This Burger is one of the bests' },
  ];
//toggle design
